...
async def delete_system_messages(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        is_system_message = (
            ...
            update.message.from_user.is_bot  # Messages generated by bot actions (e.g., kick, ban)
        )
...
application.add_handler(MessageHandler(filters.ALL & ~filters.COMMAND & ~filters.UpdateType.MESSAGE, delete_system_messages))
